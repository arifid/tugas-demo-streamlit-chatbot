...
st.title("💬 Tugas Meringkas Dokumen PDF Chatbot")
st.caption("A and friendly chat using Google's Gemini Flash model")
...
st.write("""
`st.file_uploader()` Silakan upload dokumen pdf.
""")
